...
<title>Invited Talk ::ACP 2014::</title>
<!-- InstanceEndEditable -->
...
<style type="text/css">
.content div#invitedContent
{
	margin-left:30px;
}
.content div#invitedContent table
{
	width:800px;
...
.content div#invitedContent table td
{
	border:1.5px solid #06C;

}
.content div#invitedContent ul
{
	margin-left:-50px;
}
.content div#invitedContent ul li
{
	margin-top:15px;
	list-style:none;
}
.content div#invitedContent ul li p
{
	margin-top:5px;
}
.content div#invitedContent table th
{
	border:1.5px solid #06C;

}
.content div#invitedContent table th#name
{
	width:150px;
}
.content div#invitedContent table th#affiliation
{
	width:250px;
}
.content div#invitedContent table th#title
{
	width:400px;
}
.content p.tracktitle{
	color:#06C;
	font-size:17px;
	font-weight:bold;
	margin-bottom:15px;
}
.content ul#tracklist{
	margin-top:0px;
	margin-bottom:-10px;
}
.content ul#tracklist li{
	list-style:none;
	margin-top:5px;
}
.content ul#tracklist li a{
	font-size:14px;
	color:#000;
}
.content ul#tracklist li a:link{
	color:#000;
}
</style>
<!-- InstanceEndEditable -->
...
<div style="width:480px; float:left;"><gcse:search ></gcse:search></div>
 ...
 <div class="content_one">
  ...
  <?php 
	  	echo "<p>$drplstConferenceProgram->stringTitle</p>";
  		echo "<ul class=\"nav\">";
		foreach($drplstConferenceProgram->arrayContent as $conferenceProgramContent)
		{
			echo"<li><a href=\"$conferenceProgramContent->stringLink\">$conferenceProgramContent->stringTitle</a></li>";
		}
    	echo "</ul>";
  ...
  <div class="content"> <?php echo "<h1 id='$drpcttInvitedTalk->stringID' >$drpcttInvitedTalk->stringTitle</h1> $drpcttInvitedTalk->stringContent"; ?></div>
    <!-- InstanceEndEditable -->
