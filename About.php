...
<title>About ACP ::ACP 2014::</title>
<!-- InstanceEndEditable -->
...
<div style="width:480px; float:left;"><gcse:search ></gcse:search></div>
 ...
 <div class="content_one">
  ...
  <?php 
	  	echo "<p>$drplstAboutACP->stringTitle</p>";
  		echo "<ul class=\"nav\">";
		foreach($drplstAboutACP->arrayContent as $aboutContent)
		{
			echo"<li><a href=\"$aboutContent->stringLink\">$aboutContent->stringTitle</a></li>";
		}
    	echo "</ul>";
  ...
  <div class="content"> <?php
  	foreach ($drplstAboutACP->arrayContent as $aboutContent)
	{
		echo "<h1 id='$aboutContent->stringID' >$aboutContent->stringTitle</h1> $aboutContent->stringContent";
	}
	?>
