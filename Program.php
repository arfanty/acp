...
<title>Conference Program ::ACP 2014::</title>
<!-- InstanceEndEditable -->
...
.content ul#plenary li{
	height:auto;

	list-style:none;
}
.content ul#plenary img {
	margin-top:10px;
	float:left;
	width:130px;
	height:auto;
}
.content ul#plenary div#intro {
	margin-bottom:20px;
	width:650px;
	float:left;
	height:auto;
}
.content ul#plenary div#intro p{
	font-size:14px;
}
.content ul#plenary div#intro p#Name
{
	font-size:16px;
	font-weight:bold;
}
.content ul#plenary p#topic
{
	font-size:15px;
	font-weight:bold;
}
...
<div style="width:480px; float:left;"><gcse:search ></gcse:search></div>
 ...
 <div class="content_one">
  ...
  <div class="content"> <?php
		...
		echo "<h1 id='$drpcttSpeeches->stringID' >$drpcttSpeeches->stringTitle</h1> $drpcttSpeeches->stringContent";
