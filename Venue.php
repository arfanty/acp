...
.content div#traffic img
{
	width:600px;
	height:auto;
}
.content div#ShanghaiView img
{
...
.content .bustable tr th {
	border:1.5px solid #06C;
	font-family: Arial, Helvetica, sans-serif;
	font-size:16px;
	text-align:center;
}
.content .bustable tr td {
	border:1.5px solid #06C;
	font-family: Arial, Helvetica, sans-serif;
	font-size:14px;
	text-align:center;
...
<div style="width:480px; float:left;"><gcse:search ></gcse:search></div>
 ...
 <div class="content_one">
  ...
  <div class="content"> <?php echo "<h1>$drpcttVenue->stringTitle</h1> $drpcttVenue->stringContent" ?>
