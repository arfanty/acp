...
<title>Social Activities ::ACP 2014::</title>
<!-- InstanceEndEditable -->
...
<style type="text/css">
.content div#dragonship{
	margin-top:15px;
	text-align:center;
	margin-bottom:15px;
}
.content div#dragonship img{
	width:600px;
	height:auto;
}
</style>
...
<div style="width:480px; float:left;"><gcse:search ></gcse:search></div>
 ...
 <div class="content_one">
  ...
  <div class="content"> <?php echo "<h1>$drpcttSocialActivities->stringTitle</h1>
  $drpcttSocialActivities->stringContent" ?>
 </div>
  <!-- InstanceEndEditable -->
