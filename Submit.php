...
<title>Paper Submission ::ACP 2014::</title>
<!-- InstanceEndEditable -->
...
<div style="width:480px; float:left;"><gcse:search ></gcse:search></div>
 ...
 <div class="content_one">
  ...
  <?php 
	  	echo "<p>$drplstPaperSubmission->stringTitle</p>";
  		echo "<ul class=\"nav\">";
		foreach($drplstPaperSubmission->arrayContent as $paperSubmissionContent)
		{
			echo"<li><a href=\"$paperSubmissionContent->stringLink\">$paperSubmissionContent->stringTitle</a></li>";
		}
    	echo "</ul>";
  ...
  <div class="content">
   <?php 
	foreach($drplstPaperSubmission->arrayContent as $paperSubmissionContent)
	{
  		echo "<h1 id=\"$paperSubmissionContent->stringID\">$paperSubmissionContent->stringTitle</h1> $paperSubmissionContent->stringContent ";
	}
   ?>
