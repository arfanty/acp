...
<title>Exhibition ::ACP 2014::</title>
<!-- InstanceEndEditable -->
...
.content div#hallImage
{
	text-align:center;
}
.content table#exhibitionImage
{
	margin:0 auto;
}
.content div#hallImage p
{
	font-size:17px;
	font-weight:bold;
}
.content table#exhibitionImage td
{
	font-size:17px;
	font-weight:bold;
	text-align:center;
...
<div style="width:480px; float:left;"><gcse:search ></gcse:search></div>
 ...
 <div class="content_one">
  ...
  <?php 
	  	echo "<p>$drplstExhibition->stringTitle</p>";
  		echo "<ul class=\"nav\">";
		foreach($drplstExhibition->arrayContent as $exhibitionContent)
		{
			echo"<li><a href=\"$exhibitionContent->stringLink\">$exhibitionContent->stringTitle</a></li>";
		}
    	echo "</ul>";
  ...
  <div class="content"> <?php
  	foreach ($drplstExhibition->arrayContent as $exhibitionContent)
	{
		echo "<h1 id='$exhibitionContent->stringID' >$exhibitionContent->stringTitle</h1> $exhibitionContent->stringContent";
	}
	?>
