...
<title>Special Symposium ::ACP 2014::</title>
<!-- InstanceEndEditable -->
...
.content ul.speakerlist{
	padding-left:0;
	list-style:none;

}
.content ul.speakerlist li{
	margin-top:10px;
}
.content ul.speakerlist p{
	margin-top:0px;
}
</style>
<!-- InstanceEndEditable -->
...
<div style="width:480px; float:left;"><gcse:search ></gcse:search></div>
 ...
 <div class="content_one">
  ...
  <?php 
  		...
  		echo "<ul class=\"nav\">";
		foreach($drplstConferenceProgram->arrayContent as $conferenceProgrameContent)
		{
			echo"<li><a href=\"$conferenceProgrameContent->stringLink\">$conferenceProgrameContent->stringTitle</a></li>";
		}
    	echo "</ul>";
  ...
  <div class="content"> <?php echo "<h1>$drpcttSpecialSymposium->stringTitle</h1> $drpcttSpecialSymposium->stringContent" ?>
</div>
  <!-- InstanceEndEditable -->
