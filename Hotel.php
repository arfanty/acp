...
<title>Hotel Reservation ::ACP 2014::</title>
<!-- InstanceEndEditable -->
...
.content .hoteltable tr th {
	border:1.5px solid #06C;
	font-family: Arial, Helvetica, sans-serif;
	font-size:16px;
	text-align:center;
}
.content .hoteltable tr td {
	border:1.5px solid #06C;
	font-family: Arial, Helvetica, sans-serif;
	font-size:14px;
	text-align:center;
...
<div style="width:480px; float:left;"><gcse:search ></gcse:search></div>
 ...
 <div class="content_one">
  ...
  <div class="content"> <?php echo "<h1>$drpcttHotel->stringTitle</h1> $drpcttHotel->stringContent" ?>
